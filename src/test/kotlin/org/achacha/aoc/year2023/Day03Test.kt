...
class Day03Test {
    ...
    fun `is symbol in grid`() {
        ...
        // Outside the grid
        assertFalse(day.isSymbolAtGridLocation(grid, -1, 0))
        assertFalse(day.isSymbolAtGridLocation(grid, 0, 3))
        assertFalse(day.isSymbolAtGridLocation(grid, 3, 1))
        assertFalse(day.isSymbolAtGridLocation(grid, 3, -1))

        assertTrue(day.isSymbolAtGridLocation(grid, 1, 0))
        assertTrue(day.isSymbolAtGridLocation(grid, 0, 2))
    }
